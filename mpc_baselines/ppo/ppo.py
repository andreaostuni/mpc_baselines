...
from mpc_baselines.common.buffers import MPCRolloutBuffer
from mpc_baselines.common.utils import get_q_p_from_tensor
from mpc_baselines.common.policies import (
    MPCActorCriticCnnPolicy,
    MPCActorCriticPolicy,
    MPCMultiInputActorCriticPolicy,
)
from mpc_baselines.common.on_policy_algorithm import MPCOnPolicyAlgorithm

SelfMPCPPO = TypeVar("SelfMPCPPO", bound="MPCPPO")


class MPCPPO(MPCOnPolicyAlgorithm):
    """
        ...
        if self.env is not None:
            ...
            if buffer_size % batch_size > 0:
                warnings.warn(
                    ...
                    f" but because the `MPCRolloutBuffer` is of size `n_steps * n_envs = {buffer_size}`,"
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values, log_prob, entropy = self.policy.evaluate_actions(
                    rollout_data.observations, rollout_data.mpc_states, actions
                )
