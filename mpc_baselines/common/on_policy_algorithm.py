...
import stable_baselines3.common.on_policy_algorithm as sb3_on_policy_algorithm 

from mpc_baselines.common.policies import MPCActorCriticPolicy
SelfMPCOnPolicyAlgorithm = TypeVar("SelfMPCOnPolicyAlgorithm", bound="MPCOnPolicyAlgorithm")


class MPCOnPolicyAlgorithm(BaseAlgorithm):
    """
    The base for On-Policy algorithms (ex: A2C/PPO) with MPC controller.
    ...
    def _setup_model(self) -> None:
        ...
        if self.rollout_buffer_class is None:
            if isinstance(self.observation_space, spaces.Dict):
                self.rollout_buffer_class = MPCDictRolloutBuffer
            else:
                self.rollout_buffer_class = MPCRolloutBuffer
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                mpc_state_tensor = obs_as_tensor(self._last_mpc_state, self.device)
                actions, values, log_probs = self.policy(obs_tensor, mpc_state_tensor)  # type: ignore[arg-type]
            ...
            rollout_buffer.add(
                ...
                actions,
                self._last_mpc_state,  # type: ignore[arg-type]
                rewards,
    ...
    def learn(
        self: SelfMPCOnPolicyAlgorithm,
        total_timesteps: int,
        callback: MaybeCallback = None,
        log_interval: int = 1,
        tb_log_name: str = "MPCOnPolicyAlgorithm",
        reset_num_timesteps: bool = True,
        progress_bar: bool = False,
    ) -> SelfMPCOnPolicyAlgorithm:
        iteration = 0
